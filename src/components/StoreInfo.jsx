...
import {singleRestaurant} from '../redux/features/restaurantSlice'
const StoreInfo = () => {
          ...
          <div className="flex flex-col items-center sm:px-5 md:flex-row">
            ...
            md:space-y-5"
              ...
              uppercase inline-block"
                ...
                <p className=" text-3xl font-bold leading-none lg:text-3xl xl:text-4xl">{item.city}</p>
                  <p className="text-sm font-medium inline">price :{item.price}</p>
